    ...
    return (
      <>
        <div className="w-full h-fit p-4 bg-BlueGrey text-black dark:bg-BlueBlack dark:text-white rounded-lg">
          ...
          />
          <textarea
            className="text-sm md:text-base p-4 rounded-md w-full h-fit max-h-128 mt-4 focus:outline-none focus:ring-2 focus:ring-Green dark:bg-BlackBG dark:text-white"
