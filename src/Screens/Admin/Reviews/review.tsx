    ...
    <>
      <div className="h-screen w-screen overflow-x-hidden overflow-y-clip bg-WhiteBG dark:bg-BlackBG pb-28 pt-2">
        ...
        <div className="flex h-full flex-row px-4">
          <div className="h-full w-96 overflow-y-scroll p-4 text-black dark:text-white bg-BlueGrey dark:bg-BlueBlack scrollbar-thin scrollbar-track-transparent scrollbar-thumb-DarkBlueGrey dark:scrollbar-thumb-BlueGrey scrollbar-thumb-rounded-lg rounded-l-xl">
            <div className="">
