  ...
  return (
    <>
      <div className="w-full h-full">
        <div className="flex flex-row justify-between px-6 py-8 bg-LightBlueGrey dark:bg-BlueBlack dark:text-WhiteBG duration-ThemeDuration">
        ...
        <div className="grid grid-cols-3 h-[80vh] gap-4 px-6 pb-4 bg-LightBlueGrey dark:bg-BlueBlack dark:text-WhiteBG duration-ThemeDuration">
