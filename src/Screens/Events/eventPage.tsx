  ...
  return (
    <>
      <div className="w-screen h-screen bg-WhiteBG dark:bg-BlackBG overflow-x-hidden">
        <Navbar />
        <div className="flex flex-row w-full h-full max-w-7xl mx-auto grid-cols-3 space-x-4">
          <div className="w-1/4 h-fit col-span-1 hidden lg:block">
            <EventsFilter />
          </div>
          ...
          <div className="flex flex-col w-full lg:w-3/4 grid-cols-2">
            <div className="flex flex-row space-x-4">
              ...
              <button className="bg-BlueGrey dark:bg-BlueBlack h-fit w-fit p-3 rounded-lg">
                <svg
